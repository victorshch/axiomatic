...
from axiomatic.objective_function import ObjectiveFunction, TestObjectiveFunction
...
genetic_recognizer_stage = GeneticRecognizerTrainingStage(dict(n_jobs=1, population_size=100, iteration_count=5, use_question_mark=False, num_axioms_weight=0.1))
